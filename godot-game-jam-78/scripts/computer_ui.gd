...
func _ready():
	...
	for programs in running_programs.get_children():
...
func _input(_event):
	...
	if Input.is_action_just_pressed("enter") and booting_up == false:
